...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Guardians of the Galaxy Vol. 3</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/guardioes-galaxia.jpg" alt="" style="max-width: 300px;">
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="d-flex">
                        <h6 class="mr-2">Release Date:</h6>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">May 5, 2023</p>
                        </div>
                    </div>
                    <div class="d-flex">
                    ...
                    <div class="d-flex mb-5">
                        ...
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">Science Fiction, Action, Fantasy</p>
                        </div>
                    </div>
                    <p>Closing of the trilogy starring Peter Quill / Star-Lord (Chris Pratt), Gamora (Zoe Saldana), Rocket (Bradley Cooper), Drax (Dave Bautista) and Groot (Vin Diesel). The official synopsis has not yet been released.</p>
                </div>
            </div>
        </div>
    </div>
