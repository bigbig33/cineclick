...
<body>
    ...
    <div class="d-none d-lg-block">
        ...
        <div class="main-login pt-5 pb-5">
                <div class="">
                    <center>
	                    <h2 class="mb-5">Purchase not made!</h2>
	                    <img alt="check" src="https://cdn-icons-png.flaticon.com/512/1410/1410040.png" width="200" class="mb-4">
	                   	<p>Unable to finalize ticket purchase, please try again.</p>
                   	</center>
                </div>
        </div>
    </div>
