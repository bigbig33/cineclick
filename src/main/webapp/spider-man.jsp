...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Spider-Man No Way Home</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/Spider-Man-cartaz.jpg" alt="" style="max-width: 300px;">
                </div>
                <div class="col-lg-6 mb-4">
                    ...
                    <p>In Spider-Man: No Return Home, Peter Parker will need to deal with the consequences of his identity as the world's most beloved hero after being revealed by the Daily Bugle report, with a recording made by Mysterio in the previous film. Unable to separate his normal life from the adventures of being a superhero, as well as having his reputation ruined by thinking he was the one who killed Mysterio and putting his loved ones at risk, Parker asks Doctor Strange to make everyone forget his true identity. However, the spell doesn't go as planned and the situation becomes even more dangerous when villains from other versions of Spider-Man from other universes end up in his world. Now, Peter will not only stop villains from his other versions and return them to his original universe, but also learn that with great power comes great responsibility as a hero.</p>
                </div>
            </div>
        </div>
    </div>
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeInteiro" value="Spider-Man No Way Home" type="hidden">
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeMeia" value="Spider-Man No Way Home" type="hidden">
