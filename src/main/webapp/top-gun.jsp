...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Top Gun: Maverick</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/top-gun.jpeg" alt="" style="max-width: 250px;">
                </div>
                <div class="col-lg-6 mb-4">
                    ...
                    <p>In the sequel to Top Gun: Raging Aces, we follow the story of Pete “Maverick” Mitchell, an old-fashioned Navy pilot who has collected many decorations, combat medals and great recognition for the amount of enemy planes shot down in the last 30 years. However, none of this was enough for his career to take off, as he stopped being a captain and became an instructor. The explanation for this decline is simple: He remains the same rebellious pilot as always, who does not hesitate to break the limits and defy death. In this new adventure, Maverick needs to prove that the human factor is still fundamental in the contemporary world of technological wars.</p>
                </div>
            </div>
        </div>
    </div>
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeInteiro" value="Top Gun: Maverick" type="hidden">
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeMeia" value="Top Gun: Maverick" type="hidden">
