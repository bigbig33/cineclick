...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Black Panther: Wakanda Forever</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/pantera-negra.jpg" alt="" style="max-width: 300px;">
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="d-flex">
                        <h6 class="mr-2">Release Date:</h6>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">November 11, 2022</p>
                        </div>
                    </div>
                    <div class="d-flex">
                        <h6 class="mr-2">Runtime:</h6>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">2h 41min</p>
                        </div>
                    </div>
                    <div class="d-flex mb-5">
                        <h6 class="mr-2">Genre:</h6>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">Action, Adventure</p>
                        </div>
                    </div>
