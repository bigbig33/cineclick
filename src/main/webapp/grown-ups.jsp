...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Grown Ups</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/gente-grande-cartaz.jpg" alt="" style="max-width: 250px;">
                </div>
                <div class="col-lg-6 mb-4">
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeInteiro" value="Grown Ups" type="hidden">
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeMeia" value="Grown Ups" type="hidden">
