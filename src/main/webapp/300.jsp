...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">300</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/300-cartaz.jpg" alt="" style="max-width: 300px;">
                </div>
                <div class="col-lg-6 mb-4">
                    ...
                    <p>Greece, 480 BC. At the Battle of Thermopylae, King Leonidas (Gerard Butler) and his 300 Spartan warriors bravely fight the numerous army of King Xerxes (Rodrigo Santoro). After three days of hard fighting, all the Spartans are killed. The sacrifice and dedication of these men united Greece in combat against the Persian enemy.</p>
                </div>
            </div>
        </div>
    </div>
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeInteiro" value="300" type="hidden">
		                        ...
		                        <div class="col-xs-12">
		                            <div class="row">
		                                <div class="form-group m-b-0 col-xs-8 col-md-10">
		                                    ...
		                                    <input name="nomeFilmeMeia" value="300" type="hidden">
