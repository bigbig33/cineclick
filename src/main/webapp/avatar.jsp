...
<body>
    ...
    <div class="container-fluid">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5">Avatar 2: The Way of Water</h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/avatar.jpg" alt="" style="max-width: 300px;">
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="d-flex">
                        <h6 class="mr-2">Release Date:</h6>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">December 16, 2022</p>
                        </div>
                    </div>
                    <div class="d-flex">
                    ...
                    <div class="d-flex mb-5">
                        ...
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <p class="m-0">Science Fiction, Adventure, Action, Fantasy</p>
                        </div>
                    </div>
