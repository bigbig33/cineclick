...
<body>
    ...
    <div class="d-none d-lg-block">
        ...
        <div class="main-login pt-5 pb-5">
            <form class="card-login pt-5 pb-5" action="AtualizarSenha" method="post">
                    ...
                    <div class="form-group textfield">
                        ...
                        <div class="password-group textfield m-0">
                            <input id="confirmPassword-field" type="password" name="confirmPassword" placeholder="•••••••••••" required>
                            <span toggle="#confirmPassword-field" class="fa fa-fw fa-eye field-icon toggle-password ml-2 mt-3"></span>
                        </div>
                    </div>
